...
parser.add_argument('-e', '--errFile', type=argparse.FileType('w'), default=None, help="Pipe error output to this file")
...
p = subprocess.Popen([args.pathToLCI, args.lolcodeFile], stdin=args.inputFile, stdout=subprocess.PIPE, stderr=args.errFile)
